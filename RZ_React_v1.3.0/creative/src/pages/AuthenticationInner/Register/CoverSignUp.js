                                        ...
                                        <div className="col-lg-6">
                                            <div className="p-lg-5 p-4">
                                                    ...
                                                    <form className="needs-validation" noValidate action="index">
                                                        ...
                                                        <div className="mt-4 text-center">
                                                            <div className="signin-other-title">
                                                                <h5 className="fs-14 mb-4 title text-muted">Create account with</h5>
                                                            </div>
                                                ...
                                                <div className="mt-5 text-center">
                                                    <p className="mb-0">Already have an account ? <Link to="/auth-signin-cover" className="fw-bold text-primary text-decoration-underline"> Signin</Link> </p>
                                                </div>
                                            </div>
                                        </div>
                                    </Row>
