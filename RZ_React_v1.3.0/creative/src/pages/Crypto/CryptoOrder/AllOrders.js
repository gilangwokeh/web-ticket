                ...
                <Card>
                    ...
                    <CardBody className="border border-dashed border-end-0 border-start-0">
                        <Row className="g-2">
                            ...
                            <Col xl={2} md={4}>
                                <select className="form-control" data-choices data-choices-search-false data-choices-removeItem name="choices-single-default"
                            ...
                            <Col xl={2} md={4}>
                                <select className="form-control" data-choices data-choices-search-false data-choices-removeItem name="choices-single-default2"
