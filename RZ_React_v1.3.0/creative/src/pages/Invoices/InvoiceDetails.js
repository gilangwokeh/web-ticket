          ...
          <Col xxl={9}>
            <Card id="demo">
              ...
              <CardBody className="p-4">
                <Row className="g-3">
                  <Col lg={3} xs={6}>
                    <p className="text-muted mb-2 text-uppercase fs-13 fw-semibold">
                      Invoice No
                    </p>
                  ...
                  <Col lg={3} xs={6}>
                    ...
                    <span className="badge badge-soft-success fs-12">Paid</span>
                  </Col>
                  <Col lg={3} xs={6}>
                    <p className="text-muted mb-2 text-uppercase fs-13 fw-semibold">
                      Total Amount
              ...
              <CardBody className="p-4 border-top border-top-dashed">
                <Row className="g-3">
                  <Col sm={6}>
                    <h6 className="text-muted text-uppercase fs-13 fw-semibold mb-3">
                      Billing Address
                    </h6>
