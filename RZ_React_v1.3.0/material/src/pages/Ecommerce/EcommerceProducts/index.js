        ...
        Cell: (cellProps) => {
          return (
            <UncontrolledDropdown>
              <DropdownToggle
                href="#"
                className="btn-soft-secondary btn-sm shadow-none"
                tag="button"
              >
                      ...
                      <div className="accordion-body text-body pt-0">
                        ...
                        <div className="d-flex flex-column gap-2 mt-3">
                          ...
                          <div>
                            <button
                              type="button"
                              className="btn btn-link text-decoration-none text-uppercase fw-medium p-0 shadow-none">
                              1,235 More
                            </button>
                          </div>
                        </div>
                      ...
                      >
                        {productList && productList !== "" ? (
                          <TableContainer
                            ...
                            tableClass="mb-0 table-borderless align-middle"
