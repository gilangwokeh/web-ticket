        ...
        datasets: [
            {
                ...
                pointBorderColor: "#4b38b3",
                pointBackgroundColor: "#fff",
                pointBorderWidth: 1,
                pointHoverRadius: 5,
                pointHoverBackgroundColor: "#4b38b3",
...
const BarChart = () => {       
    const data = {
        ...
        datasets: [
            {
                label: "Sales Analytics",
                backgroundColor: "rgba(75, 56, 179, 0.8)",
                borderColor: "rgba(75, 56, 179, 0.8)",
                borderWidth: 1,
                hoverBackgroundColor: "rgba(75, 56, 179, 0.9)",
                hoverBorderColor: "rgba(75, 56, 179, 0.9)",
...
const PieChart = () => {     
    const data={
        ...
        datasets: [
            {
                data: [300, 180],
                backgroundColor: ["#45CB85","#f3f6f9"],
                hoverBackgroundColor: ["#45CB85","#f3f6f9"],
...
const DonutChart = () => {     
    const data = {
        ...
        datasets: [
            {
                data: [300, 210],
                backgroundColor: ["#4b38b3","#f3f6f9"],
                hoverBackgroundColor: ["#4b38b3","#f3f6f9"],
                hoverBorderColor: "#fff"
            }]
    },
    option = {
...
const PolarChart = () => {     
    const data = {
        ...
        datasets: [{
            ...
            backgroundColor: ["#f06548", "#45CB85", "#ffbe0b", "#4b38b3"],
