                        ...
                        <Row className="mt-n2 mb-3 mb-sm-0">
                            ...
                            <div className="col-sm order-3 order-sm-2">
                                <div className="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                    ...
                                    <button type="button" className="btn btn-ghost-secondary btn-icon btn-sm fs-16 shadow-none" id="Tooltip3">
                                        <i className="ri-delete-bin-5-fill align-bottom"></i>
                                    </button>
                                    <div className="vr align-self-center mx-2"></div>
                                    <button type="button" className="btn btn-ghost-secondary btn-icon btn-sm fs-16 shadow-none" id="Tooltip4">
                                        <i className="ri-mail-open-fill align-bottom"></i>
                                    </button>
                                    <button type="button" className="btn btn-ghost-secondary btn-icon btn-sm fs-16 shadow-none" id="Tooltip5">
                                ...
                                mailbox.map((item, key) => (
                                    <li className={item.unread ? "unread" : null} key={key}>
                                        <div className="col-mail col-mail-1">
                                            ...
                                            <button type="button" className="btn avatar-xs p-0 favourite-btn fs-15 active shadow-none">
                                                <Rating
                                                    stop={1}
                    ...
                    <OffcanvasBody className="overflow-hidden">
                        <div className="pb-4 border-bottom border-bottom-dashed">
                            <Row>
                                <Col>
                                    <div className="">
                                        <button type="button" className="btn btn-soft-danger btn-icon btn-sm fs-16 close-btn-email shadow-none" onClick={toggleRightCanvas}>
                                ...
                                <Col className="col-auto">
                                    <div className="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                        <button type="button" className="btn btn-ghost-secondary btn-icon btn-sm fs-16 favourite-btn active shadow-none">
                                            <Rating
                                                stop={1}
                                        ...
                                        <UncontrolledDropdown>
                                            <DropdownToggle tag="button" className="btn btn-ghost-secondary shadow-none btn-icon btn-sm fs-16">
                                                <i className="ri-more-2-fill align-bottom"></i>
                                            </DropdownToggle>
                                            <DropdownMenu className="dropdown-menu-end">
                                                <DropdownItem>Mark as Unread</DropdownItem>
                            ...
                            <div>
                                ...
                                <div className="bg-light px-2 py-1 rouned-bottom border">
                                    <Row>
                                        <Col>
                                            <ButtonGroup>
                                                <Button className="py-0 fs-15 shadow-none" size='sm' color='light' id="Bold1"><i className="ri-bold align-bottom"></i></Button>
                                                <Button className="py-0 fs-15 shadow-none" size='sm' color='light' id="Italic1"><i className="ri-italic align-bottom"></i></Button>
                                                <Button className="py-0 fs-15 shadow-none" size='sm' color='light' id="Link1"><i className="ri-link align-bottom"></i></Button>
                                                <Button className="py-0 fs-15 shadow-none" size='sm' color='light' id="Image1"><i className="ri-image-2-line align-bottom"></i></Button>
                                            </ButtonGroup>
                                        ...
                                        <Col className="col-auto">
                                            <UncontrolledButtonDropdown className="shadow">
                                                <Button color="success" className="btn-sm shadow-none"><i className="ri-send-plane-2-fill align-bottom" /></Button>
                                                <DropdownToggle tag="button" className="btn btn-success btn-sm  shadow-none" split>
                                                </DropdownToggle>
                                                <DropdownMenu >
