                ...
                Cell: () => {
                    return (
                        <UncontrolledDropdown>
                            <DropdownToggle tag="a" className="btn btn-soft-secondary btn-sm shadow-none">
                                ...
                                <Row className="g-3">
                                    ...
                                    <Col xxl={3} sm={4}>
                                        <div className="input-light">
                                            <select className="form-control bg-light border-light" data-choices data-choices-search-false name="choices-single-default" id="idStatus">
