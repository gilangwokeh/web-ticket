                        ...
                        <CardHeader className="border-0">
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-shrink-0">
                                    <button onClick={toggleModal} className="btn btn-primary add-btn" data-bs-toggle="modal" data-bs-target="#showModal"><i className="ri-add-line align-bottom me-1"></i> Create Tickets</button>
                                </div>
                            </div>
                        </CardHeader>
