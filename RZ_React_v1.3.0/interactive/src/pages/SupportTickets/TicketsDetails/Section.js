                            ...
                            <Row>
                                <div className="col-md">
                                    <Row className="align-items-center">
                                        ...
                                        <div className="col-md">
                                            <h4 className="fw-bold">#VLZ135 - Create an Excellent UI for a Dashboard</h4>
                                            <div className="hstack gap-3 flex-wrap">
                                                <div className="text-muted"><i className="ri-building-line align-bottom me-1"></i> Themesbrand</div>
                                                <div className="vr"></div>
                                                <div className="text-muted">Create Date : <span className="fw-semibold">20 Dec, 2021</span></div>
                                                <div className="vr"></div>
                                                <div className="text-muted">Due Date : <span className="fw-semibold">29 Dec, 2021</span></div>
                                                <div className="vr"></div>
